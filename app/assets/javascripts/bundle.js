...
var _session_api_util = __webpack_require__(52);
...
var _session_actions = __webpack_require__(154);
...
var sessionReducer = function sessionReducer() {
  ...
  switch (action.type) {
    case _session_actions.RECEIVE_CURRENT_USER:
      return (0, _merge2.default)({}, action.currentUser);
    default:
      return state;
  }
};
...
var Stack = __webpack_require__(89),
    ...
    safeGet = __webpack_require__(83);
...
var login = exports.login = function login(user) {
  return function (dispatch) {
    APIUtil.login(user).then(function (user) {
      return dispatch(receiveCurrentUser(user));
    }, function (error) {
      return dispatch(receiveErrors(error.responseJSON));
    });
